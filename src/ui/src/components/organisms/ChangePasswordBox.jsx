...
import { confirm_password_validation, old_password_validation, password_validation } from "../../utils/InputValidations";
...
const ChangePasswordBox = () => {
  ...
  const submitResettingRequest = methods.handleSubmit(async (data) => {
    ...
    setIsLoading(true);
    return authService
      .changePassword(data, params.token)
      .then((response) => {
  ...
  return (
    <div className="signUp__background signUp__glass flex justify-center items-center">
      <div className="w-[500px] h-[650px] bg-[#1A1A1AEF] rounded-[20px] flex flex-col items-center relative">
        <button
        ...
        <h2 className="text-[60px] text-white mt-10 mb-3">Change password</h2>
        {
          isLoading && (
        ...
        {response && !error && (
          <div className="w-[500px] text-center">
            ...
            <div className="flex flex-col justify-between items-center mt-[50px] h-[150px]">
              <Button id={"GetStartedButton"} title={"Get started!"} variation={1} buttonSize={1} handleClick={() => navigate("/main")} type="submit" />
            </div>
          </div>
        )}
        {error && !response && (
            ...
            <div className="changePasswordForm">
              ...
              >
                ...
                <div className="h-[200px] flex flex-col items-center justify-evenly">
                  <NoValidationPasswordInput setErrors={setErrors} {...old_password_validation} />

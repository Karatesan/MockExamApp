...
const ChangeResponseBox = ({ setResponse, response, setError, error }) => {
    return (
        ...
        <div className="signUp__background signUp__glass flex justify-center items-center">
            <div className="w-[550px] h-[300px] bg-[#1A1A1AEF] rounded-[20px] flex flex-col items-center text-center relative">
                ...
                <div className="">
                    <Button id={"Return"} title={"Back"} variation={1} buttonSize={1} handleClick={() => { setResponse(null), setError(null)}} type="submit" />
                </div>
            </div>
        </div>
    )
};
export default ChangeResponseBox;
